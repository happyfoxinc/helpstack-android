...
- Include **hs_custom_theme.xml** and **hs_light_colors.xml** in your application, under **values**
- Include **hs_light_leftchatbubble.xml** and **hs_light_rightchatbubble.xml** in your application, under **drawables**
