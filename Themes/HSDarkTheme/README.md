...
- Include **hs_custom_theme.xml** and **hs_dark_colors.xml** in your application, under **values**
- Include **hs_dark_leftchatbubble.xml** and **hs_dark_rightchatbubble.xml** in your application, under **drawables**
