...
public class FilePart extends PartBase {
	private static final String TAG = FilePart.class.getSimpleName();
    ...
    protected void sendData(OutputStream out) throws IOException {
    	Log.e(TAG, "enter sendData(OutputStream out)");
        if (lengthOfData() == 0) {
