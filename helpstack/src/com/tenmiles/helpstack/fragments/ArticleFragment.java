...
public class ArticleFragment extends HSFragmentParent {
	...
	public static final String HTML_WRAPPER_WITH_TITLE = "<!DOCTYPE html><html><head><style>body{font:14.0px helvetica} .heading{}</style></head><body><h3 class='heading'>%s</h3>%s</body></html>";
